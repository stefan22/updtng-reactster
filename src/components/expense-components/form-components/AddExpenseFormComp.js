  ...
  render() {
    ...
    return (
      <div className="addxp__form-wrap">
        <form onSubmit={this.handleSubmitExpense} id="add-expense__form">
          <div className="addxp__inner-form">
            <div className="addxp__left">
              ...
              <h4>
                Amount:{" "}
                {!!errAmt && <span>{"Please provide an amount value"}</span>}
              </h4>
              <input
                onChange={(e) => this.handleExpenseChange(e)}
                value={amount}
